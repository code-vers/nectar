...
const courseLevelTabs: CourseLevelTab[] = [
  ...
  { id: 'intermediate', label: 'Intermediate', value: CourseLavel.INTERMEDIATE },
...
const mockCourses: Course[] = [
  {
    ...
    status: true,
    course: [],
    course_banner: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRRV-gHFEYmxJWk7mkqaOKfW_j4Qd9nepaaJQ&s',
...
export default function CourseLibraryPage() {
  ...
  const getFilteredCourses = () => {
    if (activeTab === 'all') {
      ...
      const selectedLevel = courseLevelTabs.find(tab => tab.id === activeTab)?.value;
      return mockCourses.filter(course => course.lavel === selectedLevel);
    }
  };
    ...
    <div className="min-h-screen bg-(--color-page-bg) px-6 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-lg text-(--color-placeholder-text) mb-6">
          Browse our comprehensive collection of property management courses.
        </p>
      ...
      {/* Horizontal Divider */}
      <hr className="border-t border-(--color-card-border) mb-12" />
