...
const navItems: NavItem[] = [
    ...
    },
    {
        ...
        children: [
            ...
            {
                label: "My Courses",
                href: "/dashboard/education-center/my-courses",
            },
            {
                label: "Certification",
...
const ResidentNavItems: NavItem[] = [
    ...
    {
        label: "Resident success academy",
        icon: MdDashboard,
        href: "/dashboard/resident-success-academy",
    }, 
    {
        label: "Children's learning center",
        icon: MdDashboard,
        href: "/dashboard/childrens-learning-center",
    }, 
    {
        label: "Downloaded library",
        icon: MdDashboard,
        href: "/dashboard/downloaded-library",
    }, 
    {
        label: "Notification",
        icon: MdDashboard,
