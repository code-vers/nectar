...
const Invite = () => {
  ...
  Property owners and managers can invite residents to join the Resident Success Academy.
Residents gain access to valuable learning programs designed to help them become better neighbors, build stronger communities, and improve everyday living.
Residents may also choose to upgrade their membership to unlock additional courses and resources.
          </p>
