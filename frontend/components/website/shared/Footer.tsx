      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div className="flex flex-col gap-4">
          ...
          <nav className="flex flex-col gap-3">
            {['Courses', 'Download', 'Success Academy', "Children's Center"].map((item) => (
              <Link
                key={item}
                href="#"
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-start gap-2">
            <svg className="mt-0.5 flex-shrink-0" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8B95A8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <div className="flex items-center gap-2">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#8B95A8" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span className="text-xs" style={{ color: '#8B95A8' }}>9606768745666</span>
          </div>
