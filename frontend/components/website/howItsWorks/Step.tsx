...
import { HiOutlineBookOpen, HiOutlineHome, HiOutlineStar, HiOutlineUserGroup } from 'react-icons/hi';
...
const steps = [
  {
    ...
    description: 'Property owners and managers start by subscribing to the platform to gain full access to training courses, tools, and downloadable resources.',
  },
  {
    id: 2,
    icon: HiOutlineBookOpen,
    title: 'Access Courses & Resources',
    description: 'Members can explore professional training courses and download practical guides, templates, and management resources.',
  },
  {
    id: 3,
    icon: HiOutlineHome,
    title: 'Invite Your Residents',
    description: 'Owners and managers can invite residents to join the Resident Success Academy, giving them access to learning programs that support better community living.',
  },
  {
    id: 4,
    icon: HiOutlineStar,
    title: 'Residents Can Upgrade (Optional)',
    description: 'Residents can choose to upgrade their access to unlock additional courses, resources, and learning opportunities if available.',
  },
];
...
const Step = () => {
  ...
  return (
    <div className="pt-16 bg-(--color-main-bg)">
      <SectionHeading
      ...
      <div className="mx-auto mt-12 rounded-2xl p-8 max-w-360`">
