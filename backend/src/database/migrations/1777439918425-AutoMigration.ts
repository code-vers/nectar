...
export class AutoMigration1777439918425 implements MigrationInterface {
    name = 'AutoMigration1777439918425'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "course_contents" ("id" SERIAL NOT NULL, "course_id" integer NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "content_url" character varying NOT NULL, "content_type" character varying NOT NULL, "duration" integer, "order_index" integer, "status" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e56de21b785ba03619207ce8f58" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "courses" ("id" SERIAL NOT NULL, "course_title" character varying NOT NULL, "course_description" character varying NOT NULL, "category" character varying NOT NULL, "status" character varying NOT NULL, "level" character varying NOT NULL, "course_banner" character varying NOT NULL, "total_hours" integer, "total_enroll" integer, CONSTRAINT "PK_3f70a487cc718ad8eda4e6d58c9" PRIMARY KEY ("id"))`);
